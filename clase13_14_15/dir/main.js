(() => {
  ...
  const v = s("HTMLFormElement"),
    ...
    P = "0123456789",
    F = { DIGIT: P, ALPHA: j, ALPHA_DIGIT: j + j.toUpperCase() + P },
    U = s("AsyncFunction"),
    _ = {
      isArray: a,
      isArrayBuffer: l,
      ...
      function l(e, n, o) {
        ...
        if (e && !o && "object" == typeof e)
          if (_.endsWith(n, "{}"))
            ...
            (_.isArray(e) &&
              (function (e) {
                return _.isArray(e) && !e.some(q);
              })(e)) ||
            ((_.isFileList(e) || _.endsWith(n, "[]")) && (a = _.toArray(e)))
          )
            return (
              (n = I(n)),
              a.forEach(function (e, r) {
                !_.isUndefined(e) &&
                  null !== e &&
                  t.append(
                    !0 === i ? M([n], r, s) : null === i ? n : n + "[]",
                    c(e)
                  );
              }),
              !1
            );
        return !!q(e) || (t.append(M(o, n, s), c(e)), !1);
      }
      const u = [],
        f = Object.assign(z, {
          defaultVisitor: l,
      ...
      return (
        (function e(n, r) {
          if (!_.isUndefined(n)) {
            ...
            u.push(n),
              _.forEach(n, function (n, s) {
                !0 ===
                  (!(_.isUndefined(n) || null === n) &&
                    o.call(t, n, _.isString(s) ? s.trim() : s, r, f)) &&
                  e(n, r ? r.concat(s) : [s]);
              }),
              u.pop();
          }
    ...
    Y = function (e) {
      function t(e, n, r, o) {
        ...
        const i = Number.isFinite(+s),
          a = o >= e.length;
        return (
          (s = !s && _.isArray(r) ? r.length : s),
          a
            ? (_.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i)
            : ((r[s] && _.isObject(r[s])) || (r[s] = []),
              t(e, n, r[s], o) &&
                _.isArray(r[s]) &&
                (r[s] = (function (e) {
                  const t = {},
          ...
          return o || r
            ? (t.setContentType("application/json", !1),
              (function (e, t, n) {
                if (_.isString(e))
                  try {
                    return (0, JSON.parse)(e), _.trim(e);
                  } catch (e) {
  ...
  function ie(e) {
    return !1 === e || null == e ? e : _.isArray(e) ? e.map(ie) : String(e);
  }
  ...
  class ce {
    ...
    set(e, t, n) {
      ...
      const s = (e, t) => _.forEach(e, (e, n) => o(e, n, t));
      return (
    ...
    has(e, t) {
      if ((e = se(e))) {
        const n = _.findKey(this, e);
        return !(!n || void 0 === this[n] || (t && !ae(0, this[n], n, t)));
      }
      return !1;
    }
    delete(e, t) {
    ...
    normalize(e) {
      ...
      return (
        _.forEach(this, (r, o) => {
          ...
          if (s) return (t[s] = ie(r)), void delete t[o];
          const i = e
            ? (function (e) {
                return e
                  .trim()
  ...
  _.inherits(de, k, { __CANCEL__: !0 });
  const pe = de,
    he = Z.isStandardBrowserEnv
      ? {
      ...
      function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            ...
            (c.onabort = function () {
              c &&
                (n(new k("Request aborted", k.ECONNABORTED, e, c)), (c = null));
            }),
            (c.onerror = function () {
              n(new k("Network Error", k.ERR_NETWORK, e, c)), (c = null);
            }),
          ...
          void 0 === r && o.setContentType(null),
            ...
            "function" == typeof e.onDownloadProgress &&
              c.addEventListener("progress", ge(e.onDownloadProgress, !0)),
            "function" == typeof e.onUploadProgress &&
              c.upload &&
              c.upload.addEventListener("progress", ge(e.onUploadProgress)),
            (e.cancelToken || e.signal) &&
              ((i = (t) => {
                c &&
                  (n(!t || t.type ? new pe(null, e, c) : t),
                  c.abort(),
                  (c = null));
              }),
          ...
          f && -1 === Z.protocols.indexOf(f)
            ? n(new k("Unsupported protocol " + f + ":", k.ERR_BAD_REQUEST, e))
            : c.send(r || null);
        });
      },
  };
  ...
  function we(e) {
    return (
      ...
      ((e) => {
        ...
        for (
          let o = 0;
          o < t && ((n = e[o]), !(r = _.isString(n) ? be[n.toLowerCase()] : n));
          o++
        );
        if (!r) {
          if (!1 === r)
  ...
  const Oe = (e) => (e instanceof le ? e.toJSON() : e);
  function Se(e, t) {
    t = t || {};
    const n = {};
    function r(e, t, n) {
  ...
  class Ce {
    ...
    request(e, t) {
      ...
      void 0 !== n &&
        ...
        (s = o && _.merge(o.common, o[t.method])),
        s &&
          _.forEach(
    ...
    getUri(e) {
      return $(
        me((e = Se(this.defaults, e)).baseURL, e.url),
        e.params,
        e.paramsSerializer
      );
    }
  ...
  const Fe = Pe,
    Ue = (function t(n) {
      const r = new xe(n),
        o = e(xe.prototype.request, r);
      return (
        _.extend(o, xe.prototype, r, { allOwnKeys: !0 }),
  ...
  (Ue.Axios = xe),
    ...
    (Ue.mergeConfig = Se),
    (Ue.AxiosHeaders = le),
    (Ue.formToJSON = (e) => Y(_.isHTMLForm(e) ? new FormData(e) : e)),
    (Ue.HttpStatusCode = Fe),
    (Ue.default = Ue);
  const _e = Ue,
    De = document.querySelector(".form-data"),
    Le = document.querySelector(".region-name"),
    Be = document.querySelector(".api-key"),
    ke = document.querySelector(".errors"),
    qe = document.querySelector(".loading"),
    Ie = document.querySelector(".result-container"),
    Me = document.querySelector(".carbon-usage"),
    ze = document.querySelector(".fossil-fuel"),
    He = document.querySelector(".my-region"),
    Je = document.querySelector(".clear-btn");
    calculateColor = async (e) => {
    let t = [0, 150, 600, 750, 800],
      n = t.sort((t, n) => Math.abs(t - e) - Math.abs(n - e))[0],
      r = ["#2AA364", "#F5EB4D", "#9E4229", "#381D02", "#381D02"][
        t.findIndex((e) => e > n)
      ];
    chrome.runtime.sendMessage({ action: "updateIcon", value: { color: r } });
  };
  const Ke = async (e, t) => {
      try {
        await _e
          .get("https://api.co2signal.com/v1/latest", {
            params: { countryCode: t },
            headers: { "auth-token": e },
          })
          .then((e) => {
            let n = Math.floor(e.data.data.carbonIntensity);
            calculateColor(n),
              (qe.style.display = "none"),
              (De.style.display = "none"),
              (He.textContent = t),
              (Me.textContent =
                Math.round(e.data.data.carbonIntensity) +
                " grams (grams C02 emitted per kilowatt hour)"),
              (ze.textContent =
                e.data.data.fossilFuelPercentage.toFixed(2) +
    ...
    We = async () => {
      const e = localStorage.getItem("apiKey"),
        t = localStorage.getItem("region");
  ...
  De.addEventListener("submit", (e) =>
    (async (e) => {
      e.preventDefault(),
        (async (e, t) => {
          localStorage.setItem("apiKey", e),
            localStorage.setItem("region", t),
    ...
    Je.addEventListener("click", (e) =>
      (async (e) => {
        e.preventDefault(), localStorage.removeItem("region"), We();
      })(e)
    ),
    We();
})();
